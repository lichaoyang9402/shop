...
public class MyLog {
	...
	private final String POINT_CUT = "execution(public * com.log.controller.*.*(..))";
	...
	public void before(JoinPoint joinPoint) {
		...
		logger.info(signature.toString()); // String
											// com.xhx.springboot.controller.HelloController.getName(String)
		// 获取方法名
		...
		logger.info(signature.getDeclaringType().toString()); // class
		...
		logger.info(staticPart.toLongString()); // execution(public
												// java.lang.String
												// com.xhx.springboot.controller.HelloController.getName(java.lang.String))
	...
	/**
	 * 后置返回 如果第一个参数为JoinPoint，则第二个参数为返回值的信息
	...
	/**
	 * 环绕通知： 注意:Spring AOP的环绕通知会影响到AfterThrowing通知的运行,不要同时使用
	 *
	...
	public static void main(String[] args) {
		...
		logger.debug("dfddfdfd");

		logger.info("我是tom");

		String rootLoggerName = Logger.ROOT_LOGGER_NAME;

		System.out.println(rootLoggerName);
